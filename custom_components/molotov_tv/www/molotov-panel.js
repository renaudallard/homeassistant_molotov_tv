        ...
        ${i?l`
              <div class="episodes-list">
                ${r?l`<div class="episodes-loading">Chargement des episodes...</div>`:s.length>0?s.map(c=>l`
                        <div class="episode-item" @click=${()=>this._playRecordingEpisode(c,e.title)}>
                          ${c.thumbnail?l`<img class="episode-thumb" src=${c.thumbnail} loading="lazy" @load=${h=>h.target.style.display=""} @error=${h=>h.target.style.display="none"} />`:""}
      ...
      <div class="channel-row">
        <div class="channel-main">
          <img
            ...
            alt=${e.name}
            loading="lazy"
            @load=${h=>h.target.style.display=""} @error=${h=>h.target.style.display="none"}
              ...
              <div class="replay-list">
                ${c?l`<div class="replay-loading">Chargement...</div>`:o.length>0?o.map(h=>l`
                        <div class="replay-item" @click=${()=>this._playReplay(h)}>
                          ${h.thumbnail?l`<img class="replay-thumb" src=${h.thumbnail} loading="lazy" @load=${p=>p.target.style.display=""} @error=${p=>p.target.style.display="none"} />`:""}
